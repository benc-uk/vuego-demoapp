...
<template>
  <div>
    ...
    <div class="card">
      <div class="card-header bg-success h3"><fa icon="cogs" />&nbsp; System Information</div>
      <div class="card-body">
        <table v-if="info" class="table table-hover table-sm table-striped">
          <tbody>
            <tr>
              <td><fa :icon="['fab', 'docker']" fixed-width /> Containerized</td>
              <td>{{ info.isContainer ? 'Running in a container! 😁' : 'Not running in a container 😢' }}</td>
            </tr>
            <tr>
              <td><fa icon="dharmachakra" fixed-width /> Kubernetes</td>
              <td>{{ info.isKubernetes ? 'Running in Kubernetes! 😄' : 'Not running in Kubernetes 😪' }}</td>
            </tr>
            <tr>
              <td><fa icon="home" fixed-width /> Hostname</td>
              <td>{{ info.hostname }}</td>
            </tr>
            <tr>
              <td><fa icon="wrench" fixed-width /> Platform</td>
              <td>{{ info.platform }} {{ info.architecture }}</td>
            </tr>
            <tr>
              <td><fa icon="laptop-code" fixed-width /> Operating System</td>
              <td>{{ info.os }}</td>
            </tr>
            <tr>
            ...
            <tr>
              <td><fa icon="memory" fixed-width /> Memory</td>
              <td>{{ (info.mem / (1024 * 1024 * 1024)).toFixed(2) }} GB</td>
            </tr>
            <tr>
              <td><fa icon="flask" fixed-width /> Go Version</td>
              <td>{{ info.goVersion }}</td>
            </tr>
            <tr>
              <td><fa icon="project-diagram" fixed-width /> Network Address</td>
              <td>{{ info.netHost }}</td>
            </tr>
          </tbody>
        </table>
    ...
    <div class="card">
      <div class="card-header bg-success h3"><fa icon="comment-dollar" />&nbsp; Environment Variables</div>
      <div class="card-body">
